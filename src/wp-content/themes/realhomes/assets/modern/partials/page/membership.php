				...
				<div class="rh_content rh_page__content">
					...
					if ( ! empty( $enable_user_nav ) && 'true' === $enable_user_nav ) {
						if ( empty( $theme_login_url ) ) {
							alert( esc_html__( 'Login Required:', 'framework' ), sprintf( esc_html__( 'Please %1$s login %2$s to access page content!', 'framework' ), '<a href="#" id="rh_login__trigger_modal">', '</a>' ) );
						} else {
