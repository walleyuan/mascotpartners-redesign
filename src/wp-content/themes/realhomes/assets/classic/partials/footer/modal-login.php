		...
		<div class="login-section modal-section">
			...
			<form id="login-form" class="login-form" action="<?php echo admin_url( 'admin-ajax.php' ); ?>" method="post" enctype="multipart/form-data">
				<div class="form-option">
					<input id="username" name="log" type="text" class="required" placeholder="<?php esc_html_e( 'Username or Email Address', 'framework' ); ?>" title="<?php _e( '* Provide user name!', 'framework' ); ?>" autofocus required/>
				</div>
				<div class="form-option">
