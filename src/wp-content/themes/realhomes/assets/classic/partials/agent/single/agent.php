												...
												if ( ! empty( $agent_office_phone ) || ! empty( $agent_mobile ) || ! empty( $agent_office_fax ) ) {
													...
													<ul class="contacts-list">
														...
														if ( ! empty( $agent_office_phone ) ) {
															...
															?>
															: <a href="tel:// <?php echo esc_html ( $agent_office_phone ); ?>"><?php echo esc_html ( $agent_office_phone ); ?></a></li>
															<?php
														}
														if ( ! empty( $agent_mobile ) ) {
															...
															?>
															: <a href="tel:// <?php echo esc_html ( $agent_mobile ); ?>"><?php echo esc_html( $agent_mobile ); ?></a></li>
															<?php
														}
