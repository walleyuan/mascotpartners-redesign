...
<header id="header" class="clearfix">
	...
	<div id="header-top" class="clearfix">
		...
		if ( ! empty( $header_email ) ) {
			...
			<div id="contact-email">
				<img class="mail-icon" src="https://www.mascotpartners.com.au/wp-content/uploads/2018/06/mail.png" alt="mail">  &nbsp; <span class="email-us">Email us at : </span>
	...
	<div class="menu-and-contact-wrap">
        ...
        $desktop_version    =  '<a class="desktop-version" href="tel://'.$header_phone.'">' .$header_phone. '</a>';
			...
			echo '<h2  class="contact-number "><i class="fa fa-phone" aria-hidden="true"></i>
<img class="phone-icon" src="https://www.mascotpartners.com.au/wp-content/uploads/2018/06/phone_icon.png" alt="phone">' . $desktop_version . $mobile_version . '<span class="outer-strip"></span></h2>';
		}
		?>
