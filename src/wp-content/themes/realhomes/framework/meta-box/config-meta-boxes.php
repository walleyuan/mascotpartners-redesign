		...
		$meta_boxes[] = array(
			...
			'fields' => array(
				...
				array(
					...
					'desc' => esc_html__( 'Example Value: 300', 'framework' ),
					'type' => 'text',
					'std' => '',
					'columns' => 6,
					'tab' => 'details',
				...
				array(
					...
					'desc' => wp_kses(
						__( 'Provide iframe embed code for the 360 virtual tour. For more details please follow point #8 of <a href="http://realhomes.inspirythemes.biz/doc/#add-property" target="_blank">Add Property</a> page in theme documentation.', 'framework' ),
						array(
							'a' => array(
								'href' => array(),
								'target' => array(),
					...
					array(
						...
						'fields'    => array(
							...
							array(
								...
								'desc' => __( 'Example: http://realhomes-modern.inspirythemes.biz', 'framework' ),
								'type' => 'text',
								'columns'   => 6,
							),
							array(
